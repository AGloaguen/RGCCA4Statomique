...
signif_weights_RGCCA_HiearchicalSupervised_Factorial_female_bestCV = unique(bootstrap_RGCCA_HiearchicalSupervised_Factorial_female_bestCV$stats$var[signif_weights])

```

# 5. Unsupervised analysis of $L$-blocks with Sparse Generalized Canonical Correlation Analysis (SGCCA)

## 5.1 SGCCA

**Slides 28 of "RGCCA - Theory"**.

## 5.2 Tunning sparse parameters in an unsupervised analysis of the MDD data-set with SGCCA

This time, permutation is applied in order to tune the **sparsity parameters s**. Similarly as before, we set the SGCCA model to the **Complete design** with the **Factorial scheme**. We choose to explore 20 values for **"s"**
...
plot(permutation_SGCCA_C_Factorial_female)
```

## 5.3 `rgcca_stability()`: using bootstrapping to assess if variables are consistenly selected accross resamplings

This time, bootstrapping is not used to estimated a confidence interval for each variable, but rather to assess if some of them are consistently selected across resamplings.

**Slides 29 of “RGCCA - Theory”**.
...
stability_SGCCA_C_Factorial_female_bestPerm = readRDS("pre_computed_results/stability_SGCCA_C_Factorial_female_bestPerm_V3.rds")

a = plot(stability_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 1, comp = 1)
b = plot(stability_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 2, comp = 1)
c = plot(stability_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 3, comp = 1)
d = plot(stability_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 1, comp = 3)
e = plot(stability_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 2, comp = 3)
f = plot(stability_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 3, comp = 3)
g = plot(stability_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 1, comp = 4)
h = plot(stability_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 2, comp = 4)
i = plot(stability_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 3, comp = 4)
```
...
## 5.4 Bootstrapping for estimating confidence intervals

The variable selection step forbid to estimate confidence intervals for each variable. Indeed, in the previous resampling procedure, each SGCCA model is composed of a different set of variables. Thus aggregating their weights across resamplings is not advised. Here, the goal is to estimate confidence intervals in a RGCCA model (no variable selection anymore) comprising only the kept variables according to the previous procedure with `rgcca_stability()`.
...
bootstrap_SGCCA_C_Factorial_female_bestPerm = readRDS("pre_computed_results/bootstrap_SGCCA_C_Factorial_female_bestPerm_V3.rds")

a = plot(bootstrap_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 1, comp = 1)
b = plot(bootstrap_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 2, comp = 1)
c = plot(bootstrap_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 3, comp = 1)
d = plot(bootstrap_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 1, comp = 3)
e = plot(bootstrap_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 2, comp = 3)
f = plot(bootstrap_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 3, comp = 3)
g = plot(bootstrap_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 1, comp = 4)
h = plot(bootstrap_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 2, comp = 4)
i = plot(bootstrap_SGCCA_C_Factorial_female_bestPerm, n = 100, bloc = 3, comp = 4)
```
...
Bellow are the significant variables for each bock and each component. This time (thanks to `rgcca_stability()`), significant variables are identify for each block on the first three components. ==> Let us try to understand what signal was grasp by these components. 
...
## 5.5 Interpretation of the extracted components
...
# 6. Supervised analysis of $L$-blocks with SGCCA
...
plot(crossValidation_SGCCA_HiearchicalSupervised_Factorial_female)
```
...
## 6.2 Interpretation of the extracted components 
...
## 6.3 Evaluation of the stability of the variable selection step
...
stability_SGCCA_C_Factorial_female_bestCV = readRDS("pre_computed_results/stability_SGCCA_C_Factorial_female_bestCV_V3.rds")

a = plot(stability_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 1, comp = 1)
b = plot(stability_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 2, comp = 1)
c = plot(stability_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 3, comp = 1)
d = plot(stability_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 1, comp = 2)
e = plot(stability_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 2, comp = 2)
f = plot(stability_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 3, comp = 2)
g = plot(stability_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 1, comp = 3)
h = plot(stability_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 2, comp = 3)
i = plot(stability_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 3, comp = 3)
```
...
## 6.4 Bootstrapping for estimating confidence intervals
...
b = plot(bootstrap_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 2, comp = 1)
c = plot(bootstrap_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 3, comp = 1)
d = plot(bootstrap_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 1, comp = 2)
e = plot(bootstrap_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 2, comp = 2)
f = plot(bootstrap_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 3, comp = 2)
g = plot(bootstrap_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 1, comp = 3)
h = plot(bootstrap_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 2, comp = 3)
i = plot(bootstrap_SGCCA_C_Factorial_female_bestCV, n = 100, bloc = 3, comp = 3)
```
...
```{r, fig.height=6, fig.width=5, warning=FALSE, message=FALSE}
...
# length(intersect(signif_weights_RGCCA_HiearchicalSupervised_Factorial_female_bestCV, signif_weights_SGCCA_C_Factorial_female_bestCV)
# )/length(signif_weights_SGCCA_C_Factorial_female_bestCV)
```

# 7. Going futher with RGCCA
